...
function renderHeroSectionContent(heroContent) {
    var _a, _b, _c;
    heroTitle.textContent = (_a = heroContent === null || heroContent === void 0 ? void 0 : heroContent.title) !== null && _a !== void 0 ? _a : "";
    heroDescription.textContent = (_b = heroContent === null || heroContent === void 0 ? void 0 : heroContent.description) !== null && _b !== void 0 ? _b : "";
    callToActionSpan.textContent = (_c = heroContent === null || heroContent === void 0 ? void 0 : heroContent.callToAction) !== null && _c !== void 0 ? _c : "";
    const el = document.querySelector(".hero-bg-image");
    if (!el)
        return;
    el.style.setProperty("--hero-bg-desktop", `url('images/${heroContent === null || heroContent === void 0 ? void 0 : heroContent.heroImageDesktop}.jpg')`);
    el.style.setProperty("--hero-bg-mobile", `url('images/${heroContent === null || heroContent === void 0 ? void 0 : heroContent.heroImageMobile}.jpg')`);
}
export {};
